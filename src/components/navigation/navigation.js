...
import styleOnImage from "../../sass/components/navigation/navigationOnImage.module.sass"
import { useStaticQuery, graphql } from "gatsby"
import NavItems from "./navItems"

// Optimize

const Header = ( { onImage } ) => {
  ...
  if (onImage === true) {
    ...
    return (
      <nav className={styleOnImage.navigationOnImage} id="navOnImage">
        <Link to="/" className={styleOnImage.logo}>{ data.site.siteMetadata.title }
